...
let UpdateCustomerCommandHandler = class UpdateCustomerCommandHandler {
    ...
    handle(command) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedCustomer = yield this.customerRepository.update(customerData);
                return {
                    result: true,
                    value: {
                        success: true,
...
exports.UpdateCustomerCommandHandler = UpdateCustomerCommandHandler = __decorate([
    (0, typedi_1.Service)(),
